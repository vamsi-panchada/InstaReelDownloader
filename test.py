...
# Specify the parent directory where the folder is located
parent_dir = "."

# Specify the partial folder name to match
partial_folder_name = "1684673711"
...
for directory in directories:
    if partial_folder_name in directory:
